...
verifier_model_path = "google/gemma-2-9b-it" # "/mnt/d2/wyin/Hera/LLM-for-Math/Direct_Verifier/code/results/new_model_v2/verifier_final_model"  
num_votes = 1
# input_file = "./MATH_500.jsonl"
input_file = "../MATH_500.jsonl"
output_file = "../output_0123_self-refine_deepseek_gemma_no_summary.jsonl"
start_line = 0
end_line = 150
threshold = -1e7
num_ablations = 1
