...
# )
query = 'You are a math problem solver. You are suppose to output the next potential step. Do not output more than 1 steps. You have to output step No.before the step. If the answer can be derived by previous steps, please output answer with \\boxed{}. What is the potential next step based on the previous steps and question?'
