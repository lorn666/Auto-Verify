...
input_file = "./MATH_500.jsonl"
output_file = "./output_0122_self-refine_with_summary_16.jsonl"
start_line = 0
end_line = 250
threshold = 1e-7
num_ablations = 16
...
query = r"What is the potential next step(only 1 step) or answer? If the answer can be derived, output them with \boxed{} directly."
