...
verifier_model_path = "/mnt/d2/wyin/Hera/LLM-for-Math/Direct_Verifier/code/results/new_model_v2/verifier_final_model"
num_votes = 1
input_file = "../aime24.jsonl"
output_file = "./res_gemma_aime24.jsonl"
start_line = 0
end_line = 98
threshold = 1e-7
num_ablations = 32
